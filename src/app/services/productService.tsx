...
export const getProductsByCategory = async (categoryId: string): Promise<Products[]> => {
  const res = await fetch(`https://deploy-nodejs-vqqq.onrender.com/products?idcate=${categoryId}`);
...
export const getProductsBySubCategory = async (subCategoryId: string): Promise<Products[]> => {
  const res = await fetch(`https://deploy-nodejs-vqqq.onrender.com/products?idsubcate=${subCategoryId}`);
