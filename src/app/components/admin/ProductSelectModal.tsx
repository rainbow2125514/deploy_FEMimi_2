...
export default function ProductSelectModal(props: ProductSelectModalProps) {
    ...
    const getImageUrl = (image: string) => {
        if (!image) return "https://deploy-nodejs-vqqq.onrender.com/images/no-image.png";
            ...
            render: (_: any, record) => (
                <div className={styles["psm-product-cell"]}>
                    <img
                        ...
                        onError={(e) => { (e.target as HTMLImageElement).src = "https://deploy-nodejs-vqqq.onrender.com/images/no-image.png"; }}
                    />
                    <div>
